...
const AboutJoinUs = () => {
    const {aboutJoinUsContainer, aboutJoinLeft, aboutJoinRight, aboutJoinBg, aboutJoinRightHeader, aboutJoinBody, aboutJoinRightBody, aboutJoinRightBodyForm} = styles
