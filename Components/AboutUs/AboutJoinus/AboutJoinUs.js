...
const AboutJoinUs = () => {
    const {aboutJoinUsContainer, aboutJoinLeft, aboutJoinRight, aboutJoinBg, aboutJoinRightHeader, aboutJoinBody, aboutJoinRightBody, aboutJoinRightBodyForm, aboutJoinRightFooter} = styles
            ...
            <div className='container-layout'>
                <div className={aboutJoinBody}>
                    ...
                    <div className={aboutJoinRight}>
                        ...
                        {!isSubmit && <div className={aboutJoinRightBody}>
                            <p>Yunus Centre seeks like-minded individuals who are driven by a strong sense of purpose, creation and passion for excellence. If you want to be part of a strong, diverse team that has the potential to redefine the large and tune in with rapidly growing industry then join us.</p>
                            <button onClick={handleIsSubmit}>submit your CV</button>
                        </div>}
                        <div className={aboutJoinRightBodyForm}>
                            {isSubmit && <AboutForm/>}
                        </div>
                        {isSubmit && <div className={aboutJoinRightFooter}>
