            ...
            <div className='container-layout'>
                <div className={footerBody}>
                    <div className={footerBodyLeft}>
                        ...
                        <p>Founded in July 2008 by Professor Muhammad Yunus, Yunus Centre is a think tank to promote and disseminate the work and philosophy of Professor Muhammad Yunus for issues relating to the concept and practice of Social Business.</p>
                    </div>
                    <div className={footerBodyCenter}>
                        <div>
                            <div>
                                <h5><span><img src={iconMap.src} alt='map-icon' /></span> Find Us at</h5>
                                <div className='mt3'>
                                    <p>16th Floor</p>
                            ...
                            <div className='mt4'>
                                <h5 className={mailHeading}><span><img src={iconMail.src} alt='mail-icon' /></span> Email to Us</h5>
                                <div className='mt2'>
                ...
                <div className={footerBottom}>
                    ...
                    <div>
                        <ul>
                            <li><a href='/' target='_blank'>Media Kit</a></li>
                            <li><a href='/' target='_blank'>Privacy Policy</a></li>
                            <li><a href='/' target='_blank'>Contact</a></li>
                            <li><a href='/' target='_blank'>Social Business FAQ</a></li>
                        </ul>
                    </div>
                    <div className={socialMedia}>
                        <a href='/' target='_blank'><img src={mediaFb.src} alt='media'/></a>
                        <a href='/' target='_blank'><img src={mediaLinkedin.src} alt='media'/></a>
