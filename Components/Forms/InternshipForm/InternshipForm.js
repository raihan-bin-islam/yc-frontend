...
function InternshipForm(props) {
  ...
  const [fieldOfInterest, setFieldOfInterest] = useState(false, false, false, false);
        ...
        <form onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
          ...
          <div className={notableContainer}>
            ...
            <div className={`${scholarshipField} ${box}`}>
              <input id="scholarship" type="text" {...register("scholarship", { required: true })} />
              {errors.scholarship?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            <div className={`${organizationHeading} ${box}`}>
              <p>Issuing Organization</p>
            </div>
            <div className={`${organizationField} ${box}`}>
              <input id="organization" type="text" {...register("organization", { required: true })} />
              {errors.organization?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            ...
            <div className={`${issueDateField} ${box}`}>
              ...
              {errors.issueDate?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
          </div>
          ...
          <div className={activitiesContainer}>
            ...
            <div className={`${activityField} ${box}`}>
              <input id="activity" type="text" {...register("activity", { required: true })} />
              {errors.activity?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            {/* POSITION */}
            ...
            <div className={`${positionField} ${box}`}>
              ...
              {errors.position?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            {/* ACHIEVEMENT */}
            ...
            <div className={`${achievementField} ${box}`}>
              <input id="achievement" type="text" {...register("achievement", { required: true })} />
              {errors.achievement?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            ...
            <div className={`${activityPeriodFromField} ${box}`}>
              <input id="activityPeriodFrom" type="date" {...register("activityPeriodFrom", { required: true })} />
              {errors.activityPeriodFrom?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            <div className={`${activityPeriodToField} ${box}`}>
              <input id="activityPeriodTo" type="date" {...register("activityPeriodTo", { required: true })} />
              {errors.activityPeriodTo?.type === "required" && <FormErrorMessage msg="Field can not be empty" />}
            </div>
            ...
            <div className={`${whyAndExpectationField} ${box}`}>
              <textarea id="whyAndExpectation" type="text" {...register("whyAndExpectation", { required: true })} />
            ...
            <div className={`${interestInField} ${box}`}>
              <textarea id="interestIn" type="text" {...register("interestIn", { required: true })} />
            ...
            <div className={`${additionalSkillField} ${box}`}>
              <textarea id="additionalSkill" type="text" {...register("additionalSkill", { required: true })} />
            ...
            <div className={`${fieldTripField} ${box}`}>
              <textarea id="fieldTrip" type="text" {...register("fieldTrip", { required: true })} />
